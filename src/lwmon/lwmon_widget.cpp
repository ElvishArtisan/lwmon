...
//MainWidget::MainWidget(CmdSwitch *cmd,QWidget *parent)
MainWidget::MainWidget(MainWidget::Mode mode,const QString &hostname,
		       uint16_t port,bool colorize,QWidget *parent)
  : QMainWindow(parent)
{
  lw_mode=mode;
  lw_hostname=hostname;
  lw_port=port;
  lw_colorize=colorize;
